"""
    ...
    #Ashis
    I tried to run it. But, there was an error. The argument parameters are 7, but it says 8
    I changed the code and run with 7 arguments, then again I got error in 
    
    File "/home/ashis/caml_50/datasets.py", line 148, in load_lookups
...
if __name__ == "__main__":
    ...
    '''
    I made a train.sh file and run it: sh train.sh
    In train.sh, I used the following command:
    python log_reg.py 50 /mimicdata/mimic3/10k/10k_filteredCode_train_50.csv /mimicdata/mimic3/10k/10k_filteredCode_dev_50.csv /mimicdata/mimic3/10k/vocab_10k.csv mimic3 0
    '''
